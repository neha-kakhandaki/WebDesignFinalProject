...
<section id="recipe3" className="recipe-section py-5">
  <div className="row">
    <div className="col-md-6">
      <img src="/images/vegbiryaninew.jpeg" alt="Hyderabadi Veg Biryani" className="img-fluid" style={{ width: '80%', height: '99%', objectFit: 'cover' }} />
    </div>
    <div className="col-md-6">
...
<section id="recipe6" className="recipe-section py-5">
  <div className="row">
    <div className="col-md-6">
      <img src="/images/fish-biryani.jpg" alt="Fish Biryani" className="img-fluid" />
    </div>
    <div className="col-md-6">
